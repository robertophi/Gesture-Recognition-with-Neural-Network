...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(250, 390, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Minimum Gray"))
        ...
        self.checkBox_7.setText(_translate("MainWindow", "Draw Contour"))
        self.checkBox_8.setText(_translate("MainWindow", "Show Prediction"))
        
        newfont = QtGui.QFont("Times", 8, QtGui.QFont.Bold) 
        self.label_tittle.setText(_translate("MainWindow", "Reconhecimento de gestos utilizando redes neurais \nRoberto Philippi"))
        self.label_tittle.setFont(newfont)
